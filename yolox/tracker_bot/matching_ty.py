...
from yolox.tracker_bot import kalman_filter
import torch
...
def embedding_distance(tracks, detections, metric='cosine'):
    ...
    # if (tracks[0].frame_id > 10) and (tracks[0].frame_id % 5 == 0):
    # # if (tracks[0].frame_id > 10):
    #     for track in tracks:
    ...
    #     cost_matrix_3 = np.maximum(0.0, cdist(mult_features[3], det_features, metric))
    #     cost_matrix_01 = np.maximum(cost_matrix_0, cost_matrix_1)
    #     cost_matrix_02 = np.maximum(cost_matrix_2, cost_matrix_3)
    #     cost_matrix = np.maximum(cost_matrix_01, cost_matrix_02)
    #     return cost_matrix
...
def mult_embedding_distance(tracks, detections, metric='cosine'):
    ...
    cost_matrix_02 = np.minimum(cost_matrix_2, cost_matrix_3)
