...
from yolox.tracker.timer import Timer
from yolox.tracker.scoremot import ScoreMOT
...
def make_parser():
    parser = argparse.ArgumentParser("ScoreMOT Tracks For Evaluation!")
...
def image_track(predictor, vis_folder, args):
    ...
    # Tracker
    tracker = ScoreMOT(args, frame_rate=args.fps)
    ...
    for ext in seqs_ext:
        for i in seqs:
            ...
            if args.default_parameters:
                ...
                # if seq == 'MOT17-05-FRCNN' or seq == 'MOT17-06-FRCNN' or seq == 'MOT17-05-DPM' or seq == 'MOT17-05-SDP':
                ...
                if seq == 'MOT17-05-FRCNN' or seq == 'MOT17-05-DPM' or seq == 'MOT17-05-SDP':
                    args.track_buffer = 14
                elif seq == 'MOT17-06-FRCNN' or seq == 'MOT17-06-DPM' or seq == 'MOT17-06-SDP':
                    args.track_buffer = 14
                elif seq == 'MOT17-13-FRCNN' or seq == 'MOT17-14-FRCNN':
                    args.track_buffer = 25
                else:
                ...
                if seq == 'MOT17-01-FRCNN'or seq == 'MOT17-01-DPM' or seq == 'MOT17-01-SDP': # ture
                    args.track_high_thresh = 0.75
                elif seq == 'MOT17-03-FRCNN' or seq == 'MOT17-03-DPM' or seq == 'MOT17-03-SDP':
                    args.track_high_thresh = 0.65
                elif seq == 'MOT17-06-FRCNN' or seq == 'MOT17-06-DPM' or seq == 'MOT17-06-SDP':
                    args.track_high_thresh = 0.65
                elif seq == 'MOT17-12-FRCNN' or seq == 'MOT17-12-DPM' or seq == 'MOT17-12-SDP':
                    args.track_high_thresh = 0.7
                elif seq == 'MOT17-14-FRCNN'or seq == 'MOT17-14-DPM' or seq == 'MOT17-14-SDP':
                    args.track_high_thresh = 0.7
                elif seq in ['MOT20-06', 'MOT20-08']:
                    args.track_high_thresh = 0.3
                    exp.test_size = (736, 1920)
