...
from yolox.tracker_bot.timer import Timer
# from yolox.tracker_zty.bot_sort_ty import BoTSORT
from yolox.tracker_bot.bot_sort import BoTSORT
...
def make_parser():
    ...
    parser.add_argument("--fast-reid-config", dest="fast_reid_config", default=r"fast_reid/configs/DanceTrack/sbs_S50.yml", type=str, help="reid config file path")
    parser.add_argument("--fast-reid-weights", dest="fast_reid_weights", default=r"pretrained/dancetrack_sbs_S50.pth", type=str, help="reid config file path")
...
if __name__ == "__main__":
    ...
    if args.benchmark == 'MOT20':
        ...
        MOT = 17
    elif args.benchmark == 'sportsmot':
        test_seqs = os.listdir(data_path + '/val')
        print(test_seqs)
        seqs_ext = ['']
        MOT = ''
    ...
    for ext in seqs_ext:
        for i in seqs:
            ...
            if args.default_parameters:
                ...
                # else:  # MOT17
                #     if ablation:
                #         args.exp_file = r'./exps/example/mot/yolox_x_ablation.py'
                #         args.ckpt = r'./pretrained/bytetrack_ablation.pth.tar'
                #     else:
                #         args.exp_file = r'./exps/example/mot/yolox_x_mix_det.py'
                #         args.ckpt = r'./pretrained/bytetrack_x_mot17.pth.tar'
                # args.exp_file = r'./exps/example/mot/yolox_x_mot17_half.py'
                # args.ckpt = r'./pretrained/yolox_x_mot17.pth.tar'
                # args.exp_file = r'./exps/example/mot/yolox_x_mot20_half.py'
                # args.ckpt = r'./pretrained/yolox_x_mot20.pth.tar'
                args.exp_file = r'./exps/example/mot/yolox_x_sports.py'
                args.ckpt = r'./pretrained/yolox_x_sports_train.pth.tar'
                exp = get_exp(args.exp_file, args.name)

                args.track_high_thresh = 0.6
                args.track_low_thresh = 0.1
                args.track_buffer = 50
