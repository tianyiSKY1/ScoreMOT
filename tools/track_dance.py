...
from yolox.tracker_z.timer import Timer
# from yolox.tracker_zty.bot_sort_ty import BoTSORT
from yolox.tracker_z.bot_sort_os import BoTSORT
    ...
    for ext in seqs_ext:
        for i in seqs:
            ...
            if args.default_parameters:
                ...
                args.exp_file = r'./exps/example/mot/yolox_x_dance.py'
                args.ckpt = r'./pretrained/bytetrack_dance.pth.tar'
