...
def txt2img(visual_path="visual_yolox_x"):
    ...
    gt_json_path = 'datasets/MOT17/annotations/train.json'
    img_path = 'datasets/MOT17/train/'
    ...
    test_json_path = 'datasets/MOT17/annotations/test.json'
    test_img_path = 'datasets/MOT17/test/'
    ...
    # test_json_path = 'datasets/MOT20/annotations/test.json'
    # test_img_path = 'datasets/MOT20/test/'
    # test_show_video_names = ['MOT20-04',
    #                          'MOT20-06',
    #                          'MOT20-07',
    #                          'MOT20-08']

    # if visual_path == "visual_test_predict":
    if visual_path == "visual_yolox_x":
    ...
    for show_video_name in show_video_names:
        ...
        if visual_path == "visual_val_gt":
            # txt_path = 'datasets/MOT17/test/' + show_video_name + '/gt/gt.txt'
            txt_path = 'YOLOX_outputs/20_scoremot/train/' + show_video_name + '.txt'
        elif visual_path == "visual_yolox_x":
            txt_path = 'YOLOX_outputs/20_scoremot/track_results_dti/'+ show_video_name + '.txt'
